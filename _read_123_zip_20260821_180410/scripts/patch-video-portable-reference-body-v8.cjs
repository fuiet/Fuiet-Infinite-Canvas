...
// Browser: no /__browser_media or blob: address may escape into an upstream JSON request.
{
  ...
  // The generic non-video branch must keep its original body behavior.
...
// Browser-facing cache bust: core + runtime changed, bootstrap reloads app consistently.
