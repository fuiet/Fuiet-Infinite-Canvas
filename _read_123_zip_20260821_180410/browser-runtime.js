...
async function ensureMediaServiceWorker(){
  ...
  try{
    const registration=await navigator.serviceWorker.register('./browser-media-sw.js?v=20260831-media-width-unified-1',{scope:'./',updateViaCache:'none'});try{await registration.update()}catch{}
