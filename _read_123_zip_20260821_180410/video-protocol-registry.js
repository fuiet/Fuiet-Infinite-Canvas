...
function xogpuVideoProfile(provider,model,operation){
  ...
  return{...base,profile:'xogpu:minimax-h3',createPath:'/v1/videos',createCandidates:['/v1/videos','/v1/videos/generations','/v1/video/generations'],pollPath:'/v1/videos/{{taskId}}',pollPathCandidates:['/v1/videos/{{taskId}}','/v1/videos/generations/{{taskId}}','/v1/video/generations/{{taskId}}','/v1/tasks/{{taskId}}'],strictPollPath:true,taskIdPath:'id',taskIdPaths:['id','task_id','taskId',...COMMON_TASK_IDS],statusPath:'status',statusPaths:['status',...COMMON_STATUS],progressPath:'progress',progressPaths:['progress',...COMMON_PROGRESS],outputPath:'',outputPaths:[],contentPath:'/v1/videos/{{taskId}}/content',contentPathCandidates:['/v1/videos/{{taskId}}/content','/v1/videos/generations/{{taskId}}/content','/v1/video/generations/{{taskId}}/content'],requestTransport:'json',referenceTransport:'url',allowOutputWithoutTerminalStatus:false,pollIntervalMs:15000,timeoutMs:3600000,videoOperation:operation};
}
