(() => {
  ...
  function renderNode(n){
    ...
    if(n.type==='text')n.textEditing=n.textInputMode==='manual';
  ...
  function renderToolbar(){
    ...
    if(n?.type==='text'&&n.textInputMode==='manual'){
