...
function xogpuKnownModels(){
  ...
  return[{id:'MiniMax-H3',name:'MiniMax H3',modality:'video',enabled:true,adapterKey:'standard-video-async-v1',createPath:'/v1/videos',method:'POST',responseMode:'async',videoProtocolFamily:'xogpu-minimax-h3',referenceTransport:'auto',operationRoutes:{'text-to-video':{createPath:'/v1/videos',requestTransport:'json'},'image-to-video':{createPath:'/api/user/discount-video-studio/jobs',requestTransport:'multipart',strictCreatePath:true,strictMediaTransport:true,noJsonFallback:true},'first-last-frame':{createPath:'/api/user/discount-video-studio/jobs',requestTransport:'multipart',strictCreatePath:true,strictMediaTransport:true,noJsonFallback:true},'reference-to-video':{createPath:'/api/user/discount-video-studio/jobs',requestTransport:'multipart',strictCreatePath:true,strictMediaTransport:true,noJsonFallback:true}},capabilities:{durations,resolutions:['768p'],aspectRatios,supportedDurations:durations,supportedResolutions:['768p'],supportedAspectRatios:aspectRatios,maxImages:9,maxVideos:3,maxAudios:3,maxReferenceImages:9,maxReferenceVideos:3,maxReferenceAudios:3,supportsTextToVideo:true,supportsFirstFrame:true,supportsLastFrame:true,supportsImageReference:true,supportsVideoReference:true,supportsAudioReference:true,supportsNativeAudio:true,generationModes:['text2video','image2video','frame2video','omni_reference'],outputResolution:'768p',fps:24,videoCodec:'H.264',audioCodec:'AAC',billingGroup:'discount_video_generation'}}];
}
